...
@WebServlet("/dashboard/deleted-tasks")
public class DeletedTasksServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<TaskDTO> lista = taskService.listAllDeletedTasksPagineted(userId, offset);
            ...
            request.getRequestDispatcher("list-deleted-tasks.jsp").forward(request, response);
        } catch (Exception e) {
